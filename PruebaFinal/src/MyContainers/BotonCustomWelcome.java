...
public class BotonCustomWelcome extends JButton {
    ...
    private Color color1 = new Color(0x233e71);
    ...
    private float sizeSpeed = 50f;
    private float alphaPressed = 0.5f;

    public BotonCustomWelcome() {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, Color.WHITE, width, 0, Color.WHITE);
        g2.setPaint(gra);
